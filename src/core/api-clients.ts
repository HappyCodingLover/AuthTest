...
export interface IClient {
   ...
   * @return Successful Response
   */
  admin_remove_agent_post(
    body: App__api__admin__schema__RemoveUser
   ...
   * @return Successful Response
   */
  admin_get_agent_post(
    body: App__api__admin__schema__GetAgent
  ): Promise<BaseResponse>;
  ...
  agent_create_user_post(
    body: AgentCreateUser
  ): Promise<AgentCreateUserResponse>;
   ...
   * @return Successful Response
   */
  agent_remove_user_post(
    body: App__api__agent__schema__RemoveUser
  ): Promise<BaseResponse>;
   ...
   * @return Successful Response
   */
  agent_get_agent_post(
    body: App__api__agent__schema__GetAgent
   ...
   * @return Successful Response
   */
  agent_get_agent_users_post(
    body: GetAgentUsers
  ): Promise<GetAgentUsersResponse>;
   ...
   * @return Successful Response
   */
  credit_create_credit_post(
    body: CreateUserCredit
  ): Promise<CreateUserCreditResponse>;
   ...
   * @return Successful Response
   */
  credit_update_credit_post(
    body: UpdateUserCredit
  ): Promise<UpdateUserCreditResponse>;
   ...
   * @return Successful Response
   */
  game_get_all_games_post(
    body: ListAllGames
  ): Promise<PagedListAllGamesResponse>;

  /**
   * Get Bet History
   * @return Successful Response
   */
  history_get_bet_history__post(
    body: GetBetHistory
   ...
   * @return Successful Response
   */
  history_get_action_history__post(
    body: GetActionHistory
   ...
   * @return Successful Response
   */
  history_get_payment_history__post(
    body: GetPaymentHistory
...
export class Client implements IClient {
  ...
  protected processAuth_create_user_post(
    response: Response
  ...
  protected processAuth_generate_password_post(
    response: Response
  ): Promise<GeneratePasswordResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAuth_admin_login_post(
    response: Response
  ): Promise<TokenResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAuth_agent_login_post(
    response: Response
  ): Promise<TokenResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAuth_email_login_post(
    response: Response
  ): Promise<TokenResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAdmin_create_admin_post(
    response: Response
  ): Promise<AdminUserCreateResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAdmin_create_agent_post(
    response: Response
  ...
  protected processAdmin_update_agent_post(
    response: Response
  ...
  protected processAdmin_remove_agent_post(
    response: Response
  ): Promise<BaseResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAdmin_list_agents_post(
    response: Response
  ): Promise<ListAdminUserResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processAdmin_get_agent_post(
    response: Response
  ): Promise<BaseResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAdmin_search_users_post(
    response: Response
  ...
  protected processAgent_create_user_post(
    response: Response
  ): Promise<AgentCreateUserResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAgent_update_user_post(
    response: Response
  ...
  protected processAgent_remove_user_post(
    response: Response
  ): Promise<BaseResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAgent_list_agents_post(
    response: Response
  ): Promise<PagedBaseResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processAgent_get_agent_post(
    response: Response
  ): Promise<GetAgentResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processAgent_get_agent_users_post(
    response: Response
  ): Promise<GetAgentUsersResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUser_get_user_data_get(
    response: Response
  ): Promise<LoadUserResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processUser_post_user_data_post(
    response: Response
  ): Promise<LoadUserResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUser_list_all_users_post(
    response: Response
  ...
  protected processCredit_create_credit_post(
    response: Response
  ): Promise<CreateUserCreditResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processCredit_get_credit_post(
    response: Response
  ...
  protected processCredit_update_credit_post(
    response: Response
  ): Promise<UpdateUserCreditResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGame_create_game_post(
    response: Response
  ...
  protected processGame_get_game_post(
    response: Response
  ...
  protected processGame_update_game_post(
    response: Response
  ...
  protected processGame_get_all_games_post(
    response: Response
  ): Promise<PagedListAllGamesResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processHistory_get_bet_history__post(
    response: Response
  ): Promise<GetBetHistoryResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processHistory_get_action_history__post(
    response: Response
  ): Promise<GetActionHistoryResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processHistory_get_payment_history__post(
    response: Response
  ): Promise<GetPaymentHistoryResponse> {
    const status = response.status;
    let _headers: any = {};
